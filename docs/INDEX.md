...
│   ├── GPU-OPTIMIZATION-SUMMARY.md        - GPU 优化总结报告（单 pass/staging pool/va_cache/多采样/分桶缓存） 🚀 **NEW**
│   ├── GPU-PERF-SUMMARY.md                - Windows DX12 vs GLES GPU 后端对比摘要 📊 **NEW**
│   ├── GPU-COMPARE.html                   - Windows GPU 后端对比折线图 (Chart.js) 📈 **NEW**
│   ├── GPU-PLATFORMS-SUMMARY.md           - 跨平台 GPU 后端对比摘要（Windows/Linux） 📊 **NEW**
│   ├── GPU-PLATFORMS.html                 - 跨平台 GPU 对比折线图（Windows/Linux Vulkan） 📈 **NEW**
│   ├── GPU-SAMPLING-ANALYSIS.md           - 单次 vs 多次采样稳健性分析 📊 **NEW**
│   ├── GPU-BUCKET-CACHE-DESIGN.md         - GPU 尺寸分桶缓存优化设计文档 🎯 **NEW**
│   ├── GPU-BUCKET-CACHE-PHASE2-RESULTS.md - GPU Bucket Cache Phase 2 部署报告（35-54% 性能提升）✅ **NEW**
│   ├── GPU-PIPELINING-PHASE3-PREVIEW.md    - GPU Phase 3 预研：批内两段流水线重叠（10-16% 提升样本） 🧪 **NEW**
│   ├── GPU-CRYPTO-ACCELERATION.md         - GPU 密码学批量加速（Phase 13 M13.3：10x+ 哈希吞吐量）⚡ **NEW**
│   ├── MERKLE-GPU-ACCELERATION.md         - GPU Merkle 树加速（Phase 13 M13.4：5-20x 构建加速）🌳 **NEW**
│   ├── ZK-GPU-ACCELERATION-PLAN.md        - GPU ZK 证明加速计划（Phase 13 M13.5：20x+ prove 加速）🔐 **NEW**
│   ├── WSL2-GPU-SETUP.md                  - WSL2 + Linux Vulkan GPU 测试环境配置指南 🐧 **NEW**
...
- [CROSS-CHAIN-ARCHITECTURE.md](./CROSS-CHAIN-ARCHITECTURE.md) - 跨链总体架构与路线
- [MULTICHAIN-ARCHITECTURE-VISION.md](./MULTICHAIN-ARCHITECTURE-VISION.md) - 多链架构愿景
- [cross-executor-usage.md](./cross-executor-usage.md) - Cross-Chain Executor 使用指南（unstable-examples）
