...
fn main() -> Result<()> {
    ...
    let mut owned1 = [0u8; 32];
    owned1[0] = 10;
    let mut owned2 = [0u8; 32];
    owned2[0] = 11;
    ...
    println!(
        "Fast: success={}, failed={}, conflicts={}",
        fast_result.successful, fast_result.failed, fast_result.conflicts
    );
    println!(
        "Consensus: success={}, failed={}, conflicts={}",
        consensus_result.successful, consensus_result.failed, consensus_result.conflicts
    );
